  ...
  services = {
    ...
    cron = {
      ...
      systemCronJobs = [
        ...
        "4,9,14,19,24,29,34,39,44,49,54,59 * * * * sleep 29 ; wget --no-check-certificate -O - https://freedns.afraid.org/dynamic/update.php?RnBTMHFiQlhHWnVmUXpNYmtLWlQ0ZXB5OjIxNjg5NzI5 >> /tmp/freedns_ug_kyrgyzstan_kg.log 2>&1 &"
      ];
    };
  };
