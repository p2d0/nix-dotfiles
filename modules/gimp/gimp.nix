...
{
  home.file = {
    ".config/GIMP/2.10/scripts".source = config.lib.file.mkOutOfStoreSymlink /etc/nixos/modules/gimp/scripts;
    ".config/GIMP/2.10/plug-ins".source = config.lib.file.mkOutOfStoreSymlink /etc/nixos/modules/gimp/plug-ins;
  };
  # home.file = {
