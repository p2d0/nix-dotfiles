function record_webcam
    ...
    # No sound
    ffmpeg -framerate 30 -f v4l2 -video_size 1280x720 -i /dev/video0  -vf 'format=nv12,hwupload' -b:v 1M -vaapi_device /dev/dri/renderD128 -c:v h264_vaapi  (date "+/home/andrew/Videos/%Y-%m-%d").mp4
end
