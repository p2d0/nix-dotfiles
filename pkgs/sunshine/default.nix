...
stdenv'.mkDerivation rec {
  pname = "sunshine";
  version = "2025.1020.124847";

  src = fetchFromGitHub {
    owner = "LizardByte";
    repo = "Sunshine";
    tag = "v${version}";
    hash = "sha256-zl05SkSNdubvSbQ2rqZ7Cw5IGYh2K+sP+PU29H2Qo6U=";
  ...
  ui = buildNpmPackage {
    inherit src version;
    pname = "sunshine-ui";
    npmDepsHash = "sha256-tynTDUYDl3WjPkcQvOB3Ym74kaP9D+lNv/q5k94WhIE=";
  ...
  postPatch = ''
    ...
    cp packaging/linux/dev.lizardbyte.app.Sunshine.desktop packaging/linux/sunshine.desktop
